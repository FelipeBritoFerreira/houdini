...
// $(".modal-galeria-campanha").ready(function() {
//
//     alert("RODANDO");
// });
...
$(document).ready(function($) {
    ...
    // $.ajax({
    //     type : "GET",
    //     url : "/galeria/montarThumbnails",
    //     beforeSend : function() {
    //         $("#galeria-campanhas").html(progressBarGaleria);
    //     },
    //     success : function(data) {
    //         $("#galeria-campanhas").html(data);
    //     },
    //     error : function(e) {
    //         $("#galeria-campanhas").html("Erro ao buscar a galeria");
    //         console.log(e);
    //     }
    // });
    // //#popular galerias
    ...
    // $.ajax({
    //     type : "GET",
    //     url : "/galeria/montarModais",
    //     // beforeSend : function() {
    //     //     $("#modal-include").html(progressBarGaleria);
    //     // },
    //     success : function(data) {
