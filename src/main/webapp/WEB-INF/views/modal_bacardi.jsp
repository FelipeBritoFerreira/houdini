...
<div class="modal fade" id="galeria_bacardi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="color: #2a6496">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">  &times;</span></button>
                <h4 class="modal-title" id="myModalLabel">
                    <span class="titulo-modal">Bacardi</span>
                </h4>
            </div>
            <div class="modal-body" >
                <div class="row">
                    <div class="col-xs-12 texto-modal">
                        ...
                        <p>
                            Desafio: Ativação do novo rum Bacardi Big Apple no Rock in Rio.
                        </p>
                        ...
                        <br><br>Os coquetéis criados pelo mixologista Alex Mesquita especialmente para o evento puderam ser degustados na área VIP do Rock in Rio, exclusiva para convidados.                    </div>
                </div>
                ...
                <c:forEach var="i" begin="1" end="6">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <img src="<c:url value="/img/galeria/bacardi/ba${i}.jpg" />" style="width: 100%"/>
                        </div>
                    </div>
                </c:forEach>
